...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    constructor() {
        ...
        //   *** Your code here ***
        iLendingPool = ILendingPool(AAVE_LENDING_POOL);
        usdt = IERC20(USDT);
    ...
    function operate() external {
        ...
        //    *** Your code here ***
        (, , , , , uint256 healthFactor) = iLendingPool.getUserAccountData(TARGET_USER);

        require(healthFactor < 10**health_factor_decimals, "Oops, not liquidatable");
        ...
        require(pair != address(0), "the pair swap failed");


        // 3. Convert the profit into ETH and send back to sender
        //    *** Your code here ***
        IUniswapV2Pair(pair).swap(0, 1e6**4, address(this), abi.encode("flash_loan"));
        // END TODO
    }
